...
class OrderStatisticsServiceTest {
	...
	void sendOrderStatisticsMail() {
	    // given
		LocalDateTime now = LocalDateTime.of(2025, 5, 13, 0, 0,0);
		...
		Order order1 = createPaymentCompletedOrder(LocalDateTime.of(2025,5,12,23,59, 59), products);
		Order order2 = createPaymentCompletedOrder(now, products);
		Order order3 = createPaymentCompletedOrder(LocalDateTime.of(2025,5,13,23,59, 59), products);
		Order order4 = createPaymentCompletedOrder(LocalDateTime.of(2025,5,14,0,0, 0), products);
		...
		// when
		boolean result = orderStatisticsService.sendOrderStatisticsMail(LocalDate.of(2025, 5, 13), "test@test.com");
